...
menuItem5 = MenuItem(name="Beef Noodle Soup",
                     description="A Chinese noodle soup made of stewed or red braised beef, beef broth, vegetables "
                                 "and Chinese noodles.",
...
menuItem6 = MenuItem(name="Ramen",
                     description="a Japanese noodle soup dish. It consists of Chinese-style wheat noodles served in a "
                                 "meat- or (occasionally) fish-based broth, often flavored with soy sauce or miso, "
                                 "and uses toppings such as sliced pork, dried seaweed, kamaboko, and green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
...
menuItem1 = MenuItem(name="Pho",
                     description="a Vietnamese noodle soup consisting of broth, linguine-shaped rice noodles called "
...
menuItem2 = MenuItem(name="Chinese Dumplings",
                     description="a common Chinese dumpling which generally consists of minced meat and finely "
                                 "chopped vegetables wrapped into a piece of dough skin. The skin can be either thin "
...
menuItem3 = MenuItem(name="Gyoza",
                     description="The most prominent differences between Japanese-style gyoza and Chinese-style "
                                 "jiaozi are the rich garlic flavor, which is less noticeable in the Chinese version, "
                                 "the light seasoning of Japanese gyoza with salt and soy sauce, and the fact that "
...
menuItem1 = MenuItem(name="Tres Leches Cake",
                     description="Rich, luscious sponge cake soaked in sweet milk and topped with vanilla bean "
...
menuItem3 = MenuItem(name="Honey Boba Shaved Snow",
                     description="Milk snow layered with honey boba, jasmine tea jelly, grass jelly, caramel, cream, "
